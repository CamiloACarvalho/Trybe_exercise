...
const movies = [
  {
    ...
    },
    {
      ...
      "title": "Titanic",
      "subtitle": "",
      "storyline": "Um artista pobre e uma jovem rica se conhecem e se apaixonam na fatídica jornada do Titanic, em 1912. Embora esteja noiva do arrogante herdeiro de uma siderúrgica, a jovem desafia sua família e amigos em busca do verdadeiro amor.",
      "rating": 4.5,
    ...
    },
    {
      ...
      "title": "Phantasm IV",
      "subtitle": "Oblivion",
      "storyline": "Um adolescente e seus amigos enfrentam um misterioso ladrão de túmulos conhecido apenas como o Homem Alto, que mantém um arsenal letal de armas terríveis com ele.",
      "rating": "4.9",
      "imagePath": "images/phantasm.jpg",
      "bookmarked": true,
      "genre": "terror"
    }
];
